...
- [`01_OpenClaw_Guide.md`](01_OpenClaw_Guide.md) — OpenClaw 설치 및 활용
- [`02_MCP_Pack_Guide.md`](02_MCP_Pack_Guide.md) — 7개 MCP 사용법 + 실전 예제
- [`03_Claude_Code_Guide.md`](03_Claude_Code_Guide.md) — Claude Code 설치/활용 + 병렬 작업법
...
자동 설치가 실패하면 [`02_MCP_Pack_Guide.md`](02_MCP_Pack_Guide.md)의 "수동 설치" 섹션을 참고하세요.
...
**[psj950101-dev](https://github.com/psj950101-dev)** (성준)
